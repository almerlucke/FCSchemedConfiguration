Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   Create one configuration plist that can hold different values for the same key depending on the scheme you set.
  ...
  s.platform     = :ios, '7.0'
  s.source       = { :git => 'https://github.com/lickylick/FCSchemedConfiguration.git', :tag => 'v1.1.0' }
